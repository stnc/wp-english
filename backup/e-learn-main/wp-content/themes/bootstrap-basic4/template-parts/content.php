...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        ...
        <?php
              $quiz = get_post_meta($post->ID,'StncBabOneEng-meta_quiz',true);

        $pdf= get_post_meta($post->ID,'StncBabOneEng-meta_pdf',true);

  
        ?>
       <?php if ($quiz!=""){?>
        <iframe src="<?php echo $quiz?>" height="500" width="100%" style="border:0"></iframe>
        <?php } ?>

        <?php if ($pdf!=""){?>
        <object data="http://localhost:8082/wp-content/uploads/2023/<?php echo $pdf?>" type="application/pdf" width="100%" height="500px">
