...
$CHfw_meta_key_video = 'CHfw-videoLocation-Setting';
 ...
 */
class CHfw_metabox_engine_video_member
{
	...
	public function __construct($fields, $CHfw_meta_key_video, $SaveMethodSingle = false)
	{

		$this->meta_key = $CHfw_meta_key_video;
...
function CHfw_video_options_()
{
	include('metabox_video_options.php');
	$ch_post_options_video['0'] = $CHfw_OptionsPageSettingvideo;

	$engine_page_video = new CHfw_metabox_engine_video_member($ch_post_options_video, 'CHfw-videoLocation-Setting', true);


}


if ($CHfw_post_type == 'video') {
//video
	CHfw_video_options_();
}


if ($CHfw_post_type_post == 'video') {
//video
	CHfw_video_options_();
}


function CHfw_video_options_locaiton()
{
	include('metabox_video_options.php');
	$ch_post_options_video['0'] = $CHfw_OptionsPageSettingvideoLocaiton;
	$engine_page_video = new CHfw_metabox_engine_video_member($ch_post_options_video, 'CHfw-videoLocation-Setting', false);
