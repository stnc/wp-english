...
class Helix_wp_word_list_table extends WP_List_Table
{
	...
	function column_main_language($item)
	{
		...
		$actions = [
			...
			'edit' => sprintf('<a href="?page=helix_building_company&trigger=edit&id=%s&_wpnonce=%s">%s</a>',  absint($item['id']), $delete_nonce, $editLangs)
		];
			...
			<div id="advanced" class="postbox ">
				<div class="inside">
					<div class="card shadow1" style="max-width:100%!important">
						...
						<div><mark class="dont"></mark> <a href="/wp-admin/admin.php?page=helix_building_company&trigger=show&building_id=<?php echo $data->building_id; ?>&_id=<?php echo $data->_id; ?>&id=<?php echo $data->id; ?>"><?php esc_html_e('Edit', 'helix-lng') ?></a> </div>
						<hr>
