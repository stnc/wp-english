                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" st_trigger=new
                            href="/wp-admin/admin.php?page=stnc_building_company&st_trigger=new&building_id=<?php echo $_GET['building_id']?>&floor_id=<?php echo $_GET['floor_id']?>">
                            <?php esc_html_e( 'Add New Company', 'the-stnc-map' ) ?></a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                        href="/wp-admin/admin.php?page=stnc_map_editor_building&st_trigger=show&teknoid=<?php echo $_GET['building_id']?>&id=<?php echo $_GET['floor_id']?>"><?php esc_html_e( 'Upload Map', 'the-stnc-map' ) ?></a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                         ...
                         foreach ($buildingsList as $building) : ?>
                            <li><a class="dropdown-item" href="/wp-admin/admin.php?page=stnc_map_view&st_trigger=editor&building_id=<?php echo $_GET['building_id']?>&floor_id=<?php echo $building->floor_id ?>"><?php echo $building->name ?></a></li>
                        <?php endforeach ?>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/wp-admin"><?php esc_html_e( 'Wordpress Dashbord', 'the-stnc-map' ) ?></a>
                    </li>
