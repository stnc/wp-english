			...
			<div id="advanced" class="postbox ">
				<div class="inside">
					<div class="card shadow1" style="max-width:100%!important">
						...
						<div><mark class="dont"></mark> <a href="/wp-admin/admin.php?page=helix_language_editor_explode&st_trigger=show&building_id=<?php echo $data->building_id; ?>&_id=<?php echo $data->_id; ?>&id=<?php echo $data->id; ?>"><?php esc_html_e('Edit', 'helix-lng') ?></a> </div>
						<hr>
